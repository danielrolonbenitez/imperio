        ...
        <div class="row">
            ...
            <div id="pre-page-content">
               <div class="alert alert-danger">
                        ...
                        <strong>INICIO!</strong> En esta pagina podra cambiar el texto de la cartelara y tambien las imagenes.
                  </div>
            </div>
            ...
            <div id="page-content">
                ...
                <!--begin cambiar texto cartelera -->
                 <?php include('../bd/conexion.php'); ?>
                 <?php include('vertextocartelera.php'); ?>
                    <span>Texto Actual De Cartelera</span>
                    <div style="padding:10px;background:black;color:pink;display:inline"><?php echo $texto->texto; ?></div><br></br>


                  <form action="cambiartextocartelera.php" method="post">
                    <label>Nuevo Texto</label>
                    <input type="text" name="carteleratext"></input>
            ...
            <!--begin cambiar texto cartelera uno-->
     <div id="uno" class="alert-warning" style="padding:10px">      
                    <span>imagen actual cartelera uno</span><br>
                     <?php $consul=mysqli_query($con,"SELECT * FROM carteleraimagen where id='1'"); $imgurl=$consul->fetch_object();?>

                    <img src="../<?php echo $imgurl->ruta; ?>" width="300"/>
                      
                   <form action="cambiarimagencartelerauno.php" method="post" enctype="multipart/form-data">
                        <label>Nueva imagen para la cartelera uno</label>
                        <input class="btn btn-warning" name="carteleraimg" type="file" />
                   ...
                   <!--begin cambiar texto cartelera dos-->
        <div id="dos" class="alert-info" style="padding:10px">  
                    <span>imagen actual cartelera dos</span><br>
                     <?php $consul=mysqli_query($con,"SELECT * FROM carteleraimagen where id='2'"); $imgurl=$consul->fetch_object();?>

                    <img src="../<?php echo $imgurl->ruta; ?>" width="300"/>
                      
                   <form action="cambiarimagencartelerados.php" method="post" enctype="multipart/form-data">
                        <label>Nueva imagen para la cartelera dos</label>
                        <input class="btn btn-info" name="carteleraimg" type="file" />
                   ...
                   <!--begin cambiar texto cartelera tres-->
                <div id="tres" class="alert-success" style="padding:10px">
                        <span>imagen actual cartelera tres</span><br>
                         <?php $consul=mysqli_query($con,"SELECT * FROM carteleraimagen where id='3'"); $imgurl=$consul->fetch_object();?>

                        <img src="../<?php echo $imgurl->ruta; ?>" width="300"/>
                          
                       <form action="cambiarimagencarteleratres.php" method="post" enctype="multipart/form-data">
                            <label>Nueva imagen para la cartelera tres</label>
                            <input class="btn btn-success" name="carteleraimg" type="file" />
