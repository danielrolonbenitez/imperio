        ...
        <div class="row">
            ...
            <div id="pre-page-content">
                 ...
                 <div class="alert alert-danger">
                        ...
                        <strong>Mensajes!</strong> En esta pagina podra ver y eliminar los mensajes.
                  </div>
            ...
            <div id="page-content">
                ...
                <?php
                    ...
                    $consul=mysqli_query($con, "SELECT * FROM mensajes");
                    
                    //var_dump($mensajes) or die();
                ...
                <table class="table table-striped col-lg-12">
                     <thead>
                      ...
                      <tbody>
                        <?php
                        while ($mensaje=$consul->fetch_object()) {
                            
                          echo "<tr>";
                          echo"<td class='menid'>",$mensaje->id,"</td>"; 
                          echo "<td>",$mensaje->nombre,"</td>"; 
                          echo "<td>",$mensaje->telefono,"</td>"; 
                          echo "<td>",$mensaje->email,"</td>"; 
                          echo "<td>",$mensaje->fecha,"</td>";  
                         
                         echo"<td><a  href='vermensaje.php?id=".$mensaje->id."'  class='open'><i class='btn btn-success btn-xs'>Ver Mensaje</i></a> ";
                       
                        echo"<a href='eliminarmensaje.php?id=".$mensaje->id."'><i class='btn btn-danger btn-xs'>Eliminar</i></a></td>";
                            echo"</tr>"; 
                        }
