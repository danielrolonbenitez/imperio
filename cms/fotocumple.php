        ...
        <div class="row">
            ...
            <div id="pre-page-content">
                 ...
                 <div class="alert alert-danger">
                        ...
                        <strong>Fotos Cumpleaños!</strong> En esta pagina podra cargar las fotos de los cumpleañeros.
                  </div>
                  <div class="alert alert-danger">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        <strong>Ayuda!</strong> 
            ...
            <div id="page-content">
                ...
                <form action="cargarfotocumple.php" method="post" enctype="multipart/form-data">
                <input class="btn btn-warning" name="fechafotocumple" type="date"  required/>
                  <input class="btn btn-warning" name="fotocumple[]" type="file" multiple required/>
