        ...
        <div class="row">
            ...
            <div id="pre-page-content">
                 ...
                 <div class="alert alert-danger">
                        ...
                        <strong>Fotos Famosos!</strong> En esta pagina podra cargar las fotos de los Famosos Artitas de Imperio.
                  </div>
            ...
            <div id="page-content">
                ...
                <!--begin cargar fotos famosos -->


                <form action="cargarfotofamosos.php" method="post" enctype="multipart/form-data">
                <input class="btn btn-warning" name="fechafotofamosos" type="date"  required/>
                  <input class="btn btn-warning" name="fotofa[]" type="file" multiple required/>
